...
urlpatterns = [
    ...
    path('gamebooks/<slug:code>/start-session/', start_reading_session, name='webui-start-session'),
    path('gamebooks/sessions/<int:session_id>/', read_session, name='webui-read-session'),
